...
class PollDetailApi(object):
    ...
    def get_poll_peer_vote_urls(self, poll_key, peer_id, urls, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_poll_peer_vote_urls(poll_key, peer_id, urls, async=True)
        >>> result = thread.get()
    ...
    def get_poll_peer_vote_urls_with_http_info(self, poll_key, peer_id, urls, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_poll_peer_vote_urls_with_http_info(poll_key, peer_id, urls, async=True)
        >>> result = thread.get()
    ...
    def get_repair_queue_data(self, poll_key, repair, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_repair_queue_data(poll_key, repair, async=True)
        >>> result = thread.get()
    ...
    def get_repair_queue_data_with_http_info(self, poll_key, repair, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_repair_queue_data_with_http_info(poll_key, repair, async=True)
        >>> result = thread.get()
    ...
    def get_tally_urls(self, poll_key, tally, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_tally_urls(poll_key, tally, async=True)
        >>> result = thread.get()
    ...
    def get_tally_urls_with_http_info(self, poll_key, tally, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_tally_urls_with_http_info(poll_key, tally, async=True)
        >>> result = thread.get()

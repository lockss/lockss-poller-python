...
class VoterPollsApi(object):
    ...
    def get_polls_as_voter(self, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_polls_as_voter(async=True)
        >>> result = thread.get()
    ...
    def get_polls_as_voter_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_polls_as_voter_with_http_info(async=True)
        >>> result = thread.get()
    ...
    def get_voter_poll_details(self, poll_key, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_voter_poll_details(poll_key, async=True)
        >>> result = thread.get()
    ...
    def get_voter_poll_details_with_http_info(self, poll_key, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_voter_poll_details_with_http_info(poll_key, async=True)
        >>> result = thread.get()
